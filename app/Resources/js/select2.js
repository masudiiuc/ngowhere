...
(function ($, undefined) {
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        setPlaceholder: function () {
            ...
            //set input box value to span
            //@M.M.H.Masud<masudiiuc@gmail.com>
            if (this.opts.element.val() != "" ) {
                console.log('select2: ami value set korbo ekn');
                this.selection.find("span").html(this.opts.element.val());
            }
        },
